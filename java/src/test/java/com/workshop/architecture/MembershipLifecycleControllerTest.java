...
import com.workshop.architecture.fitness.managing_memberships.cancel_membership.CancelMembershipResponse;
import com.workshop.architecture.fitness.managing_memberships.extend_membership.ExtendMembershipResponse;
import com.workshop.architecture.fitness.managing_memberships.handle_payment_received.PaymentReceivedResponse;
import com.workshop.architecture.fitness.managing_memberships.pause_membership.PauseMembershipResponse;
import com.workshop.architecture.fitness.managing_memberships.resume_membership.ResumeMembershipResponse;
...
class MembershipLifecycleControllerTest {
    ...
    void billableExtensionCreatesExternalInvoiceAndBillingReference() {
        ...
        assertThat(externalInvoiceProviderStore.findAll().getFirst().amountInCents()).isEqualTo(250);
        assertThat(emailService.sentEmails()).isEmpty();
    }
