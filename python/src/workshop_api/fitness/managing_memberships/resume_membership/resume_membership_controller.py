...
from workshop_api.fitness.managing_memberships.resume_membership.resume_membership_request import (
    ResumeMembershipRequest,
)
from workshop_api.fitness.managing_memberships.resume_membership.resume_membership_response import (
