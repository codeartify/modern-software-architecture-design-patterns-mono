...
from workshop_api.fitness.extend_membership.extend_membership_request import (
    ExtendMembershipRequest,
)
from workshop_api.fitness.extend_membership.extend_membership_response import (
